...
typedef enum _cardtype_t
{
	...
	CT_TWIST      = 0b1000000,
	CT_EPIC       = 0b10000000,
	CT_POISON     = 0b100000000,
	CT_ACTION     = 0b1000000000,
	CT_ALL        = 0b1111111111,
	CT_MATCH      = 0b10000000000,
	CT_MAX
} cardtype_t;

#define CARD_TYPE(a, b) ((a & b) != 0)
...
int32_t info_card_id(const card_t * card);
...
const char * info_card_discription(const card_t * card);
...
int32_t pile_suffle(pile_t * pile);
